...
export const templates: DeviceTemplate[] = [
  ...
  // ── Community Submissions: Control Processors ─────────────────────
  {
    id: "import-1776205453268-fwyuhw",
    deviceType: "control-processor",
    label: "AVPro Edge MXnet CBOX-HA",
    manufacturer: "AVPro Edge",
    modelNumber: "AC-MXNET-CBOX-HA",
    referenceUrl: "https://www.avproglobal.com/products/ac-mxnet-cbox-ha",
    searchTerms: ["avpro", "mxnet", "cbox", "control box", "ha"],
    powerDrawW: 4.5,
    heightMm: 20,
    widthMm: 200,
    depthMm: 104,
    weightKg: 0.59,
    ports: [
      port("LAN 1 (PoE)", "ethernet", "bidirectional"),
      port("LAN 2", "ethernet", "bidirectional"),
      port("LAN 3", "ethernet", "bidirectional"),
      port("LAN 4", "ethernet", "bidirectional"),
      port("LAN 5", "ethernet", "bidirectional"),
      port("LAN 6", "ethernet", "bidirectional"),
      port("LAN 7", "ethernet", "bidirectional"),
      port("LAN 8", "ethernet", "bidirectional"),
      port("System Control", "serial", "bidirectional", "phoenix"),
      port("HA Link", "serial", "bidirectional"),
      port("Service", "usb", "bidirectional", "usb-c"),
      port("12V DC", "power", "input", "barrel"),
    ],
  },
  {
    id: "import-1776205924000-exlogic",
    deviceType: "control-processor",
    label: "Biamp Tesira EX-LOGIC",
    manufacturer: "Biamp",
    modelNumber: "EX-LOGIC",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-LOGIC/ecom-item/920-00315-00001",
    searchTerms: ["biamp", "tesira", "ex-logic", "gpio", "logic", "control"],
    powerDrawW: 4,
    heightMm: 44,
    widthMm: 216,
    depthMm: 197,
    weightKg: 1,
    ports: [
      port("Control / PoE", "ethernet", "bidirectional"),
      port("Logic I/O (16 pins)", "gpio", "bidirectional", "terminal-block"),
      port("RS-232", "serial", "bidirectional", "terminal-block"),
    ],
  },
];
