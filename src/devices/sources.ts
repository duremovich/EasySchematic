...
export const templates: DeviceTemplate[] = [
  ...
  {
    id: "import-1776206081366-71m0f8",
    deviceType: "computer",
    label: "Dell OptiPlex Micro (QCM1250)",
    manufacturer: "Dell",
    modelNumber: "QCM1250",
    referenceUrl: "https://www.dell.com/en-us/shop/desktop-computers/optiplex-micro-desktop/spd/optiplex-7020-micro",
    searchTerms: ["dell", "optiplex", "micro", "qcm1250", "mini pc"],
    powerDrawW: 90,
    heightMm: 182,
    widthMm: 36,
    depthMm: 178,
    weightKg: 1.09,
    ports: [
      port("USB-C 3.2 Gen 2", "usb", "bidirectional", "usb-c"),
      port("USB-A 3.2 Gen 1", "usb", "bidirectional", "usb-a"),
      port("Headset Jack", "analog-audio", "bidirectional", "trs-eighth"),
      port("Ethernet (1G)", "ethernet", "bidirectional"),
      port("HDMI 2.1", "hdmi", "output"),
      port("DisplayPort 1.4a", "displayport", "output"),
      port("USB-A 3.2 Gen 1 (SmartPower)", "usb", "bidirectional", "usb-a"),
      port("USB-A 3.2 Gen 1", "usb", "bidirectional", "usb-a"),
      port("USB-A 2.0 (1)", "usb", "bidirectional", "usb-a"),
      port("USB-A 2.0 (2)", "usb", "bidirectional", "usb-a"),
