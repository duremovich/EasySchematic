...
export const templates: DeviceTemplate[] = [
  ...
  // ── Community Submissions: Audio-Technica Microphones ──────────────
  {
    id: "import-1776204016588-xgpue7",
    deviceType: "wired-mic",
    label: "Audio-Technica ATND8677a",
    manufacturer: "Audio-Technica",
    modelNumber: "ATND8677a",
    referenceUrl: "https://www.audio-technica.com/en-us/atnd8677a",
    powerDrawW: 1.5,
    heightMm: 46,
    widthMm: 94,
    depthMm: 133,
    weightKg: 0.77,
    ports: [
      port("Mic In", "analog-audio", "input", "xlr-3"),
      port("Dante / PoE", "dante", "bidirectional"),
    ],
  },
  {
    id: "import-1776204473341-pgurr5",
    deviceType: "wired-mic",
    label: "Audio-Technica ES915FTRH18",
    manufacturer: "Audio-Technica",
    modelNumber: "ES915FTRH18",
    referenceUrl: "https://www.audio-technica.com/en-us/es915c18",
    powerDrawW: 0.2,
    heightMm: 457,
    widthMm: 19,
    depthMm: 19,
    weightKg: 0.135,
    ports: [
      port("Output", "analog-audio", "output", "xlr-3"),
    ],
  },
  // ── Community Submissions: Biamp Tesira Expanders ─────────────────
  {
    id: "import-1776204552495-p4hvs0",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-UBT",
    manufacturer: "Biamp",
    modelNumber: "EX-UBT",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-UBT/ecom-item/920-00443-00001",
    powerDrawW: 7,
    heightMm: 24,
    widthMm: 64,
    depthMm: 106,
    weightKg: 0.1,
    ports: [
      port("AVB / PoE", "ethernet", "bidirectional"),
      port("USB Audio", "usb", "bidirectional", "usb-b"),
      port("Bluetooth", "bluetooth", "bidirectional", "wireless"),
    ],
  },
  {
    id: "import-1776205328867-4zvgow",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-USB",
    manufacturer: "Biamp",
    modelNumber: "EX-USB",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-USB/ecom-item/910-01995",
    powerDrawW: 7,
    heightMm: 24,
    widthMm: 64,
    depthMm: 106,
  ...
  {
    id: "import-1776206739808-dkopjf",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-AEC",
    manufacturer: "Biamp",
    modelNumber: "EX-AEC",
    referenceUrl: "https://products.biamp.com/product-details/-/o/category/5A68FFEE-07A9-42E8-A2BF-602A4703666F%7CA85C7B94-242C-4D10-99DD-FBA9A1D251DC%7CBD8F916A-004C-4891-8753-F701F10B301E%7C6505FF4E-A33E-4ECC-9F40-B3EED4FFCFA9/cn/Tesira-Expanders/d/Tesira-EX-AEC/ecom-item/920-00341-00001",
    powerDrawW: 30,
    heightMm: 44,
    widthMm: 216,
    depthMm: 197,
    ...
    ports: [
      port("AVB / PoE+", "ethernet", "bidirectional"),
      port("CH 1 In (AEC)", "analog-audio", "input", "phoenix"),
      port("CH 2 In (AEC)", "analog-audio", "input", "phoenix"),
      port("CH 3 In (AEC)", "analog-audio", "input", "phoenix"),
      port("CH 4 In (AEC)", "analog-audio", "input", "phoenix"),
    ],
  },
  {
    id: "import-1776211139605-bcxwng",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-IN",
    manufacturer: "Biamp",
    modelNumber: "EX-IN",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-IN/ecom-item/920-00308-00001",
    powerDrawW: 30,
    heightMm: 44,
    widthMm: 216,
    depthMm: 197,
    ...
    ports: [
      port("AVB / PoE+", "ethernet", "bidirectional"),
      port("CH 1 In", "analog-audio", "input", "phoenix"),
      port("CH 2 In", "analog-audio", "input", "phoenix"),
      port("CH 3 In", "analog-audio", "input", "phoenix"),
      port("CH 4 In", "analog-audio", "input", "phoenix"),
    ],
  },
  {
    id: "import-1776205842000-exio",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-IO",
    manufacturer: "Biamp",
    modelNumber: "EX-IO",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-IO/ecom-item/920-00310-00001",
    powerDrawW: 30,
    heightMm: 44,
    widthMm: 216,
    depthMm: 197,
    ...
    ports: [
      port("AVB / PoE+", "ethernet", "bidirectional"),
      port("CH 1 In", "analog-audio", "input", "terminal-block"),
      port("CH 2 In", "analog-audio", "input", "terminal-block"),
      port("CH 1 Out", "analog-audio", "output", "terminal-block"),
      port("CH 2 Out", "analog-audio", "output", "terminal-block"),
    ],
  },
  {
    id: "import-1776206452000-exout",
    deviceType: "audio-interface",
    label: "Biamp Tesira EX-OUT",
    manufacturer: "Biamp",
    modelNumber: "EX-OUT",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/Tesira-EX-OUT/ecom-item/920-00309-00001",
    powerDrawW: 15,
    heightMm: 44,
    widthMm: 216,
    depthMm: 197,
    ...
    ports: [
      ...
      port("CH 1 Out", "analog-audio", "output", "terminal-block"),
      port("CH 2 Out", "analog-audio", "output", "terminal-block"),
      port("CH 3 Out", "analog-audio", "output", "terminal-block"),
      port("CH 4 Out", "analog-audio", "output", "terminal-block"),
    ],
  },
  // ── Community Submissions: Biamp TesiraFORTÉ DSP Processors ───────
  {
    id: "import-1776206588000-forte-ai-v2",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ AI",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ AI",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-AI/ecom-item/920-00400-00001",
    searchTerms: ["biamp", "tesira", "forte", "dsp", "processor"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
    weightKg: 3.63,
    ports: [
      port("Control", "ethernet", "bidirectional"),
      port("USB Audio", "usb", "bidirectional", "usb-b"),
      port("RS-232", "serial", "bidirectional", "terminal-block"),
      port("Logic I/O", "gpio", "bidirectional", "terminal-block"),
      ...ports("Input", "analog-audio", "input", 12, "terminal-block"),
      ...ports("Output", "analog-audio", "output", 8, "terminal-block"),
    ],
  },
  {
    id: "import-1776206645000-forte-avb-ai",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ AVB AI",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ AVB AI",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-AVB-AI/ecom-item/920-00396-00001",
    searchTerms: ["biamp", "tesira", "forte", "avb", "dsp", "processor"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
    ...
    ports: [
      port("Control", "ethernet", "bidirectional"),
      port("AVB", "ethernet", "bidirectional"),
      port("USB Audio", "usb", "bidirectional", "usb-b"),
      port("RS-232", "serial", "bidirectional", "terminal-block"),
      port("Logic I/O", "gpio", "bidirectional", "terminal-block"),
      ...ports("Input", "analog-audio", "input", 12, "terminal-block"),
  ...
  {
    id: "import-1776206712000-forte-avb-ci",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ AVB CI",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ AVB CI",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-AVB-CI/ecom-item/920-00395-00001",
    searchTerms: ["biamp", "tesira", "forte", "avb", "aec", "dsp", "conferencing"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
    ...
    ports: [
      ...
      port("RS-232", "serial", "bidirectional", "terminal-block"),
      port("Logic I/O", "gpio", "bidirectional", "terminal-block"),
      ...ports("Input (AEC)", "analog-audio", "input", 12, "terminal-block"),
      ...ports("Output", "analog-audio", "output", 8, "terminal-block"),
    ],
  },
  {
    id: "import-1776206775000-forte-avb-vt",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ AVB VT",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ AVB VT",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-AVB-VT/ecom-item/920-00450-00001",
    searchTerms: ["biamp", "tesira", "forte", "avb", "voip", "dsp", "telephone"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
    ...
    ports: [
      port("Control", "ethernet", "bidirectional"),
      port("AVB", "ethernet", "bidirectional"),
      port("VoIP", "ethernet", "bidirectional"),
      port("POTS (Telephone)", "analog-audio", "bidirectional", "rj11"),
      port("USB Audio", "usb", "bidirectional", "usb-b"),
      port("RS-232", "serial", "bidirectional", "terminal-block"),
      port("Logic I/O", "gpio", "bidirectional", "terminal-block"),
      ...ports("Input (AEC)", "analog-audio", "input", 12, "terminal-block"),
  ...
  {
    id: "import-1776206842000-forte-avb-vt4-fixed",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ AVB VT4",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ AVB VT4",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-AVB-VT4/ecom-item/920-00452-00001",
    searchTerms: ["biamp", "tesira", "forte", "avb", "voip", "vt4", "dsp"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
    ...
    ports: [
      ...
      port("RS-232", "serial", "bidirectional", "terminal-block"),
      port("Logic I/O", "gpio", "bidirectional", "terminal-block"),
      ...ports("Input (AEC)", "analog-audio", "input", 4, "terminal-block"),
      ...ports("Output", "analog-audio", "output", 4, "terminal-block"),
    ],
  },
  {
    id: "import-1776206912000-forte-dan-ai",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ DAN AI",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ DAN AI",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-DAN-AI/ecom-item/920-00448-00001",
    searchTerms: ["biamp", "tesira", "forte", "dante", "dsp", "processor"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
  ...
  {
    id: "import-1776206982000-forte-dan-ci",
    deviceType: "audio-interface",
    label: "Biamp TesiraFORTÉ DAN CI",
    manufacturer: "Biamp",
    modelNumber: "FORTÉ DAN CI",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraFORT-DAN-CI/ecom-item/920-00447-00001",
    searchTerms: ["biamp", "tesira", "forte", "dante", "aec", "dsp", "conferencing"],
    powerDrawW: 35,
    heightMm: 44,
    widthMm: 483,
    depthMm: 267,
