...
export const templates: DeviceTemplate[] = [
  ...
  // ── Community Submissions: Network Switches & AV-over-IP ──────────
  {
    id: "import-1776204300988-tg2huz",
    deviceType: "network-switch",
    label: "Netgear GS316PP",
    manufacturer: "Netgear",
    modelNumber: "GS316PP",
    referenceUrl: "https://www.netgear.com/be/business/wired/switches/unmanaged/gs316pp/",
    searchTerms: ["netgear", "gs316pp", "poe", "unmanaged", "16 port"],
    powerDrawW: 196,
    poeBudgetW: 183,
    heightMm: 27,
    widthMm: 286,
    ...
    weightKg: 0.88,
    ports: [
      ...ports("Port", "ethernet", "bidirectional", 16),
      port("Power In", "power", "input", "barrel"),
    ],
  },
  {
    id: "import-1776205564669-xd18ln",
    deviceType: "network-switch",
    label: "AVPro Edge MXnet SW24",
    manufacturer: "AVPro Edge",
    modelNumber: "AC-MXNET-SW24",
    referenceUrl: "https://www.avproglobal.com/products/ac-mxnet-sw24",
    searchTerms: ["avpro", "mxnet", "sw24", "10g", "poe", "managed"],
    powerDrawW: 471,
    poeBudgetW: 370,
    heightMm: 44,
    widthMm: 440,
    ...
    weightKg: 4.8,
    ports: [
      ...ports("Port", "ethernet", "bidirectional", 20),
      port("Port 21 (RJ45)", "ethernet", "bidirectional"),
      port("Port 21 (SFP)", "fiber", "bidirectional", "sfp"),
      port("Port 22 (RJ45)", "ethernet", "bidirectional"),
      port("Port 22 (SFP)", "fiber", "bidirectional", "sfp"),
      port("Port 23 (RJ45)", "ethernet", "bidirectional"),
      port("Port 23 (SFP)", "fiber", "bidirectional", "sfp"),
      port("Port 24 (RJ45)", "ethernet", "bidirectional"),
      port("Port 24 (SFP)", "fiber", "bidirectional", "sfp"),
      port("SFP+ Stacking 1", "fiber", "bidirectional", "sfp"),
      port("SFP+ Stacking 2", "fiber", "bidirectional", "sfp"),
      port("SFP+ Stacking 3", "fiber", "bidirectional", "sfp"),
      port("SFP+ Stacking 4", "fiber", "bidirectional", "sfp"),
      port("MGMT", "ethernet", "bidirectional"),
      port("Console", "serial", "bidirectional"),
      port("AC Power", "power", "input", "iec"),
    ],
  },
  {
    id: "import-1776205774667-wcyy5g",
    deviceType: "av-over-ip",
    label: "AVPro Edge MXnet 10G Transceiver",
    manufacturer: "AVPro Edge",
    modelNumber: "AC-MXNET-10G-TCVR",
    referenceUrl: "https://www.avproglobal.com/products/ac-mxnet-10g-tcvr",
    searchTerms: ["avpro", "mxnet", "10g", "transceiver", "av over ip"],
    powerDrawW: 25,
    heightMm: 25,
    widthMm: 220,
    depthMm: 170,
    ...
    ports: [
      port("HDMI In", "hdmi", "input"),
      port("HDMI Out", "hdmi", "output"),
      port("Analog Audio I/O", "analog-audio", "bidirectional", "trs-eighth"),
      port("10G Copper (PoE++)", "ethernet", "bidirectional"),
      port("10G SFP+", "fiber", "bidirectional", "sfp"),
      port("1G Ethernet (ISP)", "ethernet", "bidirectional"),
      port("RS-232", "serial", "bidirectional", "phoenix"),
      port("IR In", "ir", "input", "trs-eighth"),
      port("IR Out", "ir", "output", "trs-eighth"),
      port("USB Host (Type B)", "usb", "bidirectional", "usb-b"),
      port("USB Device 1", "usb", "bidirectional", "usb-a"),
      port("USB Device 2", "usb", "bidirectional", "usb-a"),
      port("DC 12V", "power", "input", "barrel"),
    ],
  },
  {
    id: "import-1776206145000-tc5",
    deviceType: "network-switch",
    label: "Biamp TesiraCONNECT TC-5",
    manufacturer: "Biamp",
    modelNumber: "TC-5",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraCONNECT-TC-5/ecom-item/920-00039-00002",
    searchTerms: ["biamp", "tesira", "tc-5", "avb", "poe", "switch"],
    powerDrawW: 120,
    heightMm: 31,
    widthMm: 148,
    depthMm: 148,
    weightKg: 0.8,
    ports: [
      port("Port 1 (Control)", "ethernet", "bidirectional"),
      port("Port 2 (AVB / PoE+)", "ethernet", "bidirectional"),
      port("Port 3 (AVB / PoE+)", "ethernet", "bidirectional"),
      port("Port 4 (AVB / PoE+)", "ethernet", "bidirectional"),
      port("Port 5 (AVB / PoE+)", "ethernet", "bidirectional"),
      port("Power In", "power", "input", "barrel"),
    ],
  },
  {
    id: "import-1776206385000-tc5d",
    deviceType: "network-switch",
    label: "Biamp TesiraCONNECT TC-5D",
    manufacturer: "Biamp",
    modelNumber: "TC-5D",
    referenceUrl: "https://products.biamp.com/product-details/-/o/d/TesiraCONNECT-TC-5D/ecom-item/920-00087-00002",
    searchTerms: ["biamp", "tesira", "tc-5d", "avb", "dante", "poe", "switch"],
    powerDrawW: 132,
    heightMm: 28,
    widthMm: 147,
    depthMm: 147,
    weightKg: 0.7,
    ports: [
      port("Port 1 (Control / Uplink)", "ethernet", "bidirectional"),
      port("Port 2 (AVB / Dante / PoE+)", "ethernet", "bidirectional"),
      port("Port 3 (AVB / Dante / PoE+)", "ethernet", "bidirectional"),
      port("Port 4 (AVB / Dante / PoE+)", "ethernet", "bidirectional"),
      port("Port 5 (AVB / Dante / PoE+)", "ethernet", "bidirectional"),
      port("Power In", "power", "input", "barrel"),
    ],
  },
];
